...
try:
    ...
    input3.send_keys("blabla@bla.ru")
    ...
    assert excepted_text == welcome_text,\
        'Ожидаемый текст не совпал с текстом на странице сайта!\n' \
        f'Ожидаемый результат: {excepted_text}\n' \
        f'Фактический результат: {welcome_text}'
